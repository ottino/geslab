...
class PDF_header extends FPDF {
    ...
    function Header()
    {
            ...
            if ( ($this->logo == 0) || ($this->logo == 1) )
            {
              ...
              $this->SetXY(0.20,3);
              $this->Cell(2,0.22,'Protocolo Nro:    ' . $this->Comp_ProtocoloNro );

              $this->SetFont('Arial','B',8);
              $this->SetXY(16,3);
              $this->Cell(2,0.22,'Fecha:    ' . $this->Comp_Fecha);

              $this->SetFont('Arial','B',8);
              $this->SetXY(0.20,3.5);
              $this->Cell(2,0.22,'Paciente:    ' . utf8_decode($this->Comp_Paciente) );

              $this->SetFont('Arial','B',8);
              $this->SetXY(16,3.5);
              $this->Cell(2,0.22,'Edad:    ' . $this->Comp_Edad );
              ...
              $this->SetFont('Arial','B',8);
              $this->SetXY(0.20,4.5);
              $this->Cell(2,0.22,'Material Remitido:    ' . utf8_decode($this->Comp_Organo) );

              /* Segunda linea */
              $this->Line(0, 5.01 , 21, 5.01);
              $this->Line(0, 5.02 , 21, 5.02);
              $this->Line(0, 5.03 , 21, 5.03);
              $this->Line(0, 5.04 , 21, 5.04);
              $this->Line(0, 5.05 , 21, 5.05);
              $this->Line(0, 5.06 , 21, 5.06);
